 ...
 * Enable via environment variable DEBUG=unh-pages:*
 */
export const debug = {
  /** HMR related logs */
  hmr: Debug('unh-pages:hmr'),
  /** Configuration options related logs */
  options: Debug('unh-pages:options'),
  /** Main package page scanning logs */
  pages: Debug('unh-pages:pages'),
  /** Sub-package page scanning logs */
  subPages: Debug('unh-pages:subPages'),
  /** Error logs */
  error: Debug('unh-pages:error'),
  /** Cache related logs */
  cache: Debug('unh-pages:cache'),
  /** Declaration file generation logs */
  declaration: Debug('unh-pages:declaration'),
  /** definePage macro parsing logs */
  definePage: Debug('unh-pages:definePage'),
}
